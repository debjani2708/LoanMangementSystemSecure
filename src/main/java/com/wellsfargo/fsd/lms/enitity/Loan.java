package com.wellsfargo.fsd.lms.enitity;
...
public class Loan {
	...
	@Min(value=1,message="Loan Id is Mandatory")
	...
	@Max(value=1,message="Rate of Interest cannot be more than 1")
	private Double rateOfInterest;
	
	@Column(name="ec")
	@NotNull(message="EMI Count is Mandatory")
	@Min(value=1,message="EMI Coun cannot be negative or zero")
