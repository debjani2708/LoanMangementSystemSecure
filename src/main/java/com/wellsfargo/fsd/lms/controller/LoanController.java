...
public class LoanController {
    ...
    public ModelAndView doDelete(@RequestParam("id") int loanId) throws LoanException {
        loanService.deleteLoan(loanId);
        return new ModelAndView("index","msg","Loan is deleted successfully");
    }
	
	@GetMapping("/search")
	public ModelAndView displaySearch() throws LoanException {
		return new ModelAndView("search","search",new Loan());
	}
	
	@PostMapping("/search")
	public ModelAndView displaySearchBasedOnStatus(@RequestParam("status") String status) throws LoanException {
		return new ModelAndView("loanListPage", "loans",loanService.getLoanByStatus(status));
